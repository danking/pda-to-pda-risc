...
(define (reg-uses i)
  ...
  (match i
    ((assign _ reg rhs) (rhs-uses rhs))
    ((push _ rhs) (rhs-uses rhs))
    ((sem-act _ _ in _ _) (list->seteq in))
    ((block _ _) (seteq))
    ((drop-token _) (seteq))
    ((get-token _) (seteq))
    ((stack-ensure _ _) (seteq))
    ((enh:join-point _ _ _) (seteq))
    ((label _ _ _ _ _ _ _) (seteq))
    ((block* _ _) (seteq))
    ((accept _ regs) (list->seteq regs))
    ((reject _) (seteq))
    ((if-eos _ _ _) (seteq))
    ((state-case _ reg _ _) (seteq reg))
    ((token-case _ _ _) (seteq))
    ((go _ _ rhs) (list->seteq (filter register? rhs)))
    (_ (error 'reg-uses "passed something other than an insn or insn*"))))
(define (reg-defs i)
  (match i
    ((assign _ reg rhs) (seteq reg))
    ((push _ rhs) (seteq))
    ((sem-act _ _ _ out _) (list->seteq (filter register? out)))
    ((block _ term-seq) (seteq))
    ((drop-token _) (seteq))
    ((get-token _) (seteq))
    ((stack-ensure _ _) (seteq))
    ((enh:join-point _ _ regs) (list->seteq regs))
    ((label _ _ _ _ _ _ _) (seteq))
    ((block* _ _) (seteq))
    ((accept _ _) (seteq))
    ((reject _) (seteq))
    ((if-eos _ _ _) (seteq))
    ((state-case _ _ _ _) (seteq))
    ((token-case _ _ _) (seteq))
    ((go _ _ _) (seteq))
